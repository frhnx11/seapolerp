...
const MASTER_CARDS: MasterCard[] = [
  ...
  {
    title: "Importers",
    description: "Manage the importers vessels are brought in for.",
    href: "/admin/master-data/importers",
    icon: Building2,
    tile: "bg-violet-100",
  ...
  {
    title: "Discount Parties",
    description: "Manage the discount parties invoices are billed to.",
    href: "/admin/master-data/discount-parties",
    icon: Percent,
    tile: "bg-teal-100",
  ...
  {
    title: "DO Trucks",
    description: "Delivery-order trucks added from Truck DOs (view only).",
    href: "/admin/master-data/do-trucks",
    icon: Truck,
    tile: "bg-orange-100",
